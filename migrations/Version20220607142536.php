 ...
 */
final class Version20220607142536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__materiel AS SELECT id, nom_materiel FROM materiel');
        $this->addSql('DROP TABLE materiel');
        $this->addSql('CREATE TABLE materiel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_materiel VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO materiel (id, nom_materiel) SELECT id, nom_materiel FROM __temp__materiel');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__materiel AS SELECT id, nom_materiel FROM materiel');
        $this->addSql('DROP TABLE materiel');
        $this->addSql('CREATE TABLE materiel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_materiel VARCHAR(255) NOT NULL, locatier_id INTEGER DEFAULT NULL, prix_materiel DOUBLE PRECISION NOT NULL, quantite_materiel INTEGER NOT NULL)');
        $this->addSql('INSERT INTO materiel (id, nom_materiel) SELECT id, nom_materiel FROM __temp__materiel');
        $this->addSql('DROP TABLE __temp__materiel');

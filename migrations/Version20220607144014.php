 ...
 */
final class Version20220607144014 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, devis_id INTEGER DEFAULT NULL, content_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, file_path VARCHAR(255) DEFAULT NULL COLLATE BINARY)');

 ...
 */
final class Version20220602132656 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, devis_id INTEGER DEFAULT NULL, type_paiement VARCHAR(255) DEFAULT NULL COLLATE BINARY, montant_paiement DOUBLE PRECISION DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__devis AS SELECT id, chantier_id, numero_devis, prix_devis, statut FROM devis');
        $this->addSql('DROP TABLE devis');
        $this->addSql('CREATE TABLE devis (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chantier_id INTEGER DEFAULT NULL, numero_devis INTEGER NOT NULL, prix_devis DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO devis (id, chantier_id, numero_devis, prix_devis, statut) SELECT id, chantier_id, numero_devis, prix_devis, statut FROM __temp__devis');
        $this->addSql('DROP TABLE __temp__devis');
        $this->addSql('CREATE INDEX IDX_8B27C52BD0C0049D ON devis (chantier_id)');
        $this->addSql('DROP INDEX IDX_EC9FA95ED0C0049D');

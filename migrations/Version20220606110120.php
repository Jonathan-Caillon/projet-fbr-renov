 ...
 */
final class Version20220606110120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__document AS SELECT id, devis_id, nom_document FROM document');
        ...
        $this->addSql('INSERT INTO document (id, devis_id, content_url) SELECT id, devis_id, nom_document FROM __temp__document');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8B27C52BD0C0049D ON devis (chantier_id)');
        $this->addSql('DROP INDEX IDX_D8698A7641DEFADA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__document AS SELECT id, devis_id FROM document');
        $this->addSql('DROP TABLE document');
        $this->addSql('CREATE TABLE document (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, devis_id INTEGER DEFAULT NULL, nom_document VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO document (id, devis_id) SELECT id, devis_id FROM __temp__document');
        $this->addSql('DROP TABLE __temp__document');
        $this->addSql('CREATE INDEX IDX_D8698A7641DEFADA ON document (devis_id)');
        $this->addSql('DROP INDEX IDX_EC9FA95ED0C0049D');
        $this->addSql('CREATE TEMPORARY TABLE __temp__image_chantier AS SELECT id, chantier_id, image FROM image_chantier');

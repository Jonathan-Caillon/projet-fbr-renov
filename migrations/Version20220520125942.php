 ...
 */
final class Version20220520125942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__devis AS SELECT id, numero_devis, prix_devis, statut, paiement FROM devis');
        ...
        $this->addSql('INSERT INTO devis (id, numero_devis, prix_devis, statut, paiement) SELECT id, numero_devis, prix_devis, statut, paiement FROM __temp__devis');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__devis AS SELECT id, numero_devis, prix_devis, statut, paiement FROM devis');
        $this->addSql('DROP TABLE devis');
        $this->addSql('CREATE TABLE devis (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, numero_devis INTEGER NOT NULL, prix_devis DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, paiement VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO devis (id, numero_devis, prix_devis, statut, paiement) SELECT id, numero_devis, prix_devis, statut, paiement FROM __temp__devis');
        $this->addSql('DROP TABLE __temp__devis');
        $this->addSql('DROP INDEX IDX_18D2B0915632D108');
        $this->addSql('CREATE TEMPORARY TABLE __temp__materiel AS SELECT id, locatier_id, nom_materiel, prix_materiel, quantite_materiel FROM materiel');

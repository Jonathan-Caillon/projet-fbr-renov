 ...
 */
final class Version20220531094706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, chantier_id, materiel_id, quantite, prix FROM location');
        ...
        $this->addSql('INSERT INTO location (id, chantier_id, materiel_id, quantite, prix) SELECT id, chantier_id, materiel_id, quantite, prix FROM __temp__location');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__materiel AS SELECT id, locatier_id, nom_materiel FROM materiel');
        $this->addSql('DROP TABLE materiel');
        $this->addSql('CREATE TABLE materiel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, locatier_id INTEGER DEFAULT NULL, nom_materiel VARCHAR(255) NOT NULL, CONSTRAINT FK_18D2B0915632D108 FOREIGN KEY (locatier_id) REFERENCES locatier (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO materiel (id, locatier_id, nom_materiel) SELECT id, locatier_id, nom_materiel FROM __temp__materiel');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, chantier_id, materiel_id, quantite, prix FROM location');
        $this->addSql('DROP TABLE location');
        $this->addSql('CREATE TABLE location (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chantier_id INTEGER DEFAULT NULL, materiel_id INTEGER DEFAULT NULL, quantite INTEGER NOT NULL, prix DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO location (id, chantier_id, materiel_id, quantite, prix) SELECT id, chantier_id, materiel_id, quantite, prix FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE INDEX IDX_5E9E89CBD0C0049D ON location (chantier_id)');
        $this->addSql('CREATE INDEX IDX_5E9E89CB16880AAF ON location (materiel_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__materiel AS SELECT id, locatier_id, nom_materiel FROM materiel');
        $this->addSql('DROP TABLE materiel');
        $this->addSql('CREATE TABLE materiel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, locatier_id INTEGER DEFAULT NULL, nom_materiel VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO materiel (id, locatier_id, nom_materiel) SELECT id, locatier_id, nom_materiel FROM __temp__materiel');
        $this->addSql('DROP TABLE __temp__materiel');
        $this->addSql('CREATE INDEX IDX_18D2B0915632D108 ON materiel (locatier_id)');
    }

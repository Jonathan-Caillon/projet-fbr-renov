	...
	<aside :class="`${is_expanded ? 'is-expanded' : ''}`">
		...
		<div class="menu-toggle-wrap">
			<button class="menu-toggle" @click="ToggleMenu">
				<span><svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width="24" height="24" viewBox="0 0 24 24"><path d="M0 3.795l2.995-2.98 11.132 11.185-11.132 11.186-2.995-2.981 8.167-8.205-8.167-8.205zm18.04 8.205l-8.167 8.205 2.995 2.98 11.132-11.185-11.132-11.186-2.995 2.98 8.167 8.206z"/></svg></span>
			</button>
		</div>
		...
		<div class="menu" >
            ...
            <RouterLink to="/Clients" class="sidebar-link trending">
            ...
            <RouterLink to="/add" class="sidebar-link" >
              <svg class="fit"  xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd" fill="currentColor">
            ...
            <RouterLink to="/Contacts" class="sidebar-link">
             <svg  viewBox="0 0 24 24" height="20" width="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                <path d="M8.26 1.289l-1.564.772c-5.793 3.02 2.798 20.944 9.31 20.944.46 0 .904-.094 1.317-.284l1.542-.755-2.898-5.594-1.54.754c-.181.087-.384.134-.597.134-2.561 0-6.841-8.204-4.241-9.596l1.546-.763-2.875-5.612zm7.746 22.711c-5.68 0-12.221-11.114-12.221-17.832 0-2.419.833-4.146 2.457-4.992l2.382-1.176 3.857 7.347-2.437 1.201c-1.439.772 2.409 8.424 3.956 7.68l2.399-1.179 3.816 7.36s-2.36 1.162-2.476 1.215c-.547.251-1.129.376-1.733.376"/>
             </svg> 
             <p>Contacts</p>
            </RouterLink>

            <RouterLink to="/Calendrier" class="sidebar-link">
             <svg
            height="20" width="20"
            ...
            <RouterLink to="/Dépannages" class="sidebar-link">
             <svg  class="fit" xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <RouterLink to="/Locatiers" class="sidebar-link">
             <svg viewBox="0 0 24 24" fill="currentColor" height="20" width="20" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 0c6.623 0 12 5.377 12 12s-5.377 12-12 12-12-5.377-12-12 5.377-12 12-12zm0 2c5.519 0 10 4.481 10 10s-4.481 10-10 10-10-4.481-10-10 4.481-10 10-10zm2 12v-3l5 4-5 4v-3h-9v-2h9zm-4-6v-3l-5 4 5 4v-3h9v-2h-9z"/></svg>
             <p>Locatiers</p>
            </RouterLink>
       
            <RouterLink to="/Statistiques" class="sidebar-link">
             <svg xmlns="http://www.w3.org/2000/svg"  height="20" width="16" viewBox="0 0 24 24" fill="currentColor">
...
aside .sidebar.collapse .logo-expand, aside .sidebar.collapse .side-title {
  display: none;
}
aside .sidebar.collapse .logo {
  display: flex;
}
aside .sidebar.collapse .side-wrapper {
  width: 40px;
}
aside .sidebar.collapse .side-menu svg {
  margin-right: 30px;

    ...
    <div class="menu">
      ...
      <div class="menu">
        ...
        <RouterLink to="/add-chantier" class="sidebar-link trending">
          ...
          >
            <path
              d="M21.167 21h1.833v2h-22v-2h1.833l7.334-20h3.666l7.334 20zm-3.231-3h-11.872l-1.1 3h14.072l-1.1-3zm-9.306-7l-1.1 3h8.94l-1.1-3h-6.74zm2.934-8l-1.467 4h3.806l-1.467-4h-.872z"
            />
          </svg>
          <p>Chantiers</p>
        </RouterLink>
...
aside .sidebar-link:hover:nth-child(2n + 1) svg,
aside .sidebar-link.router-link-active:nth-child(2n + 1) svg {
  background: #ff7551;
  border-radius: 5px;
  padding: 3px;
}
aside .sidebar-link:hover:nth-child(2n) svg,
aside .sidebar-link.router-link-active:nth-child(2n) svg {
  background: #32a7e2;
  border-radius: 5px;
  padding: 2px;
}
aside .sidebar-link:hover:nth-child(2n + 3) svg,
aside .sidebar-link.router-link-active:nth-child(2n + 3) svg {
  background: #6c5ecf;
  border-radius: 5px;
  padding: 2px;
}
...
/* ----- LOGO NOT EXPAND -----*/
aside .sidebar.collapse .logo-expand,
aside .sidebar.collapse .side-title p {
  display: none;
}
/* ------------------------- */
